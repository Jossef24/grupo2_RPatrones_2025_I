...
| Foto | Descripción |
|---|---|
|<div align="center"><image src="https://github.com/Jossef24/grupo2_RPatrones_2025_I/blob/main/Imagenes/Foto_Nicolle.jpeg" width="300px" height="120px">| **Nicolle Muñoz Huamán**<br>*nicolle.munoz@upch.pe*<br> <p align="justify"> Estudiante de Ingeniería Biomédica en 9no ciclo, con interés en la aplicación de tecnologías emergentes en salud como impresión 3D. Tengo experiencia en la investigación de tecnología médica aplicada a la formación de personal de salud, desarrollando simuladores médicos.</p>| 
|<div align="center"><image src="https://github.com/Jossef24/grupo2_RPatrones_2025_I/blob/main/Imagenes/Foto_Jose.jpeg" width="300px" height="120px">| **Jose Rosales Juarez**<br>*jose.rosales@upch.pe*<br> <p align="justify"> Estudiante de 9no semestre de Ingeniería Biomédica, con una gran pasión por las neurociencias, la inteligencia artificial y las tecnologías de realidad extendida. Mi objetivo es revolucionar la salud pública través de la investigación de tecnologías emergentes y su aplicación en salud. Mis intereses de investigación incluyen interfaces cerebro-ordenador, aplicaciones de realidad virtual para la formación médica y soluciones basadas en IA para los retos de la atención sanitaria.</p>|
